...
<body <?php body_class();?>>
	<header class="mt-0">
		...
		<?php if(has_header_image()): ?>
			<div class="header-image header-image-size" style="background-image:url(<?php echo get_header_image(); ?>);">
				...
				<?php 
					...
					if($pageTitle != ''): 
				?>
				<div class="container-header shadow m-auto rounded">
					<h1 class="py-3 page-heading"><?php echo $pageTitle ?></h1>
				</div>
				<?php endif ?>
			</div>
		<?php endif ?>
		...
		<?php if(!has_header_image()): ?>
			<div class="header-background header-image-size" style="background-image:url(<?php echo get_header_image(); ?>);">
				<!-- parent container to the nav bar -->
				<nav class="navbar navbar-expand-md navbar-dark top-bar shadow" role="navigation">
					<div class="container-fluid">
						<!-- Branding/home button -->
